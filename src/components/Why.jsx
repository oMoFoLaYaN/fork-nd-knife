  ...
  <div key={why.title} className={layout.container}>
    ...
    <div className={`${layout.row}`}>
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="box bg-fola-100 dark:bg-fola-990 ease-in-out w-full transition-all duration-500 delay-300 px-[30px] py-[50px] my-3 lg:mx-3 rounded-md hover:pt-[30px] hover:pb-[70px] hover:px-[30px] hover:shadow-blue-500/50">
