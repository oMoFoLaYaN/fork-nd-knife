      ...
      <div
        ...
        <div className={`${layout.row}`}>
          <div class="py-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12"
                      ...
                      data-aos-once="true"
                      >
            <a onClick={() => handleScrollTo(`#specials`)} class=" group cursor-pointer inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-fola-950 hover:text-fola-100 dark:text-fola-50 rounded-full bg-fola-0 dark:bg-fola-990 dark:bg-opacity-60 bg-opacity-60 hover:bg-fola-200/30 dark:hover:bg-fola-800/40" role="alert">
