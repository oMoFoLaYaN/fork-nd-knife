      ...
      <Swiper
        ...
        <div className="swiper-slide">
          <div className="testimonial-item">
            <p className="italic relative text-fola-950 dark:text-fola-50 relative z-[1] mx-[15px] my-0 pt-5 pb-[60px] px-5 rounded-md bg-fola-100 dark:bg-fola-950 rounded-xl clay">
